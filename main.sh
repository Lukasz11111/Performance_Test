...
case $DELAY in
1)
  DELAY_array=(0 10 100 1000)
  ;;
2)
  DELAY_array=(0 10 100 250 500 1000 1500 10000)
  ;;
3)
  DELAY_array=(0 10 50 100 150 250 400 500 600 750 1000 1500 2000 3000 5000 10000)
  ;;
*)
  DELAY_array=(0)
  ;;
    ...
    if [ "$counter" -gt 0 ]; then
      for f in $FILES; do
        ...
        for ((VARIABLE = $START; VARIABLE <= $END; VARIABLE++)); do
          ...
          sudo bash stress.sh $f $VARIABLE $RAPORT_NAME $x $iZ
